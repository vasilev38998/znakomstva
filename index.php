...
$router->post('/api/notifications/delivered', [NotificationController::class, 'delivered']);
$router->post('/api/notifications/clicked', [NotificationController::class, 'clicked']);
