...
## Админка
- `/admin/index.php` доступна после входа админ-пользователя.
- Установите роль `admin` вручную в таблице `users`.
- Push-центр позволяет создать рассылку и сохранить сегменты для обработки cron-задачей.
